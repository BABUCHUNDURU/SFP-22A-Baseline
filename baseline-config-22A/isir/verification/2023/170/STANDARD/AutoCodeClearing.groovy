...
/* Baseline Configuration - 2022-2023 170 V1 - Code Clearing */
...
/* Parent Calculate Filing Threshold */
    ...
    else
    {
        ...
        if (isirPARENTSTAXRETURNFILINGSTATUS == "1")
        {
            if (parent1Under65)
            {
                parentFilingThreshold = 12400;
            }
            else
            {
                parentFilingThreshold = 14050;
            }
        }
        if (isirPARENTSTAXRETURNFILINGSTATUS == "4")
        {
            if (parent1Under65)
            {
                parentFilingThreshold = 18650;
            }
            else
            {
                parentFilingThreshold = 20300;
            }
        }
        if (isirPARENTSTAXRETURNFILINGSTATUS == "2")
        {
            ...
            {
                parentFilingThreshold = 24800;
            }
            else if ((parent1Under65 && !parent2Under65) || (!parent1Under65 && parent2Under65))
            {
                parentFilingThreshold = 26100;
            }
            else
            {
                parentFilingThreshold = 27400;
            }
        }
