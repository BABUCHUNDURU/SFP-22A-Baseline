...
{
   if (isirStudentIrsRequestFlag == "02" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag == "1" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "2" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "3" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "4") && hasRolloverStatement && hsVerificationPass && hasVerificationWorksheetIndStudent)
    {
        return true;
    }
    else if (isirStudentIrsRequestFlag == "02" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag != "1" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "2" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "3" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "4") && hsVerificationPass && hasVerificationWorksheetIndStudent)
    {
        return true;
    }
