...
/* Baseline Configuration - 2020-2021 170 V5 - Code Clearing */
...
{
   if (isirStudentIrsRequestFlag == "02" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag == "1" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "2" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "3" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "4") && hasRolloverStatement && hsVerificationPass && hasVerificationWorksheetDepStudent)
    {
        studentVerificationStatus = true;
    }
    else if (isirStudentIrsRequestFlag == "02" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag != "1" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "2" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "3" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "4") && hsVerificationPass && hasVerificationWorksheetDepStudent)
    {
        studentVerificationStatus = true;
    }
    ...
    if (isirStudentIrsRequestFlag == "07" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag != "1" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "2" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "3" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "4") && hasVerificationWorksheetDepStudent && (hasTaxTranscriptStudent || has1040Student) && has1040xStudent && hsVerificationPass)
    {
        studentVerificationStatus = true;
    }
}
