...
/* Baseline Configuration - 2020-2021 170 V1 - Code Clearing */
...
/* Student Calculate Filing Threshold */ 
	...
	{
		studentFilingThreshold = 12200;
	}
	if (isirStudentFilingStatus == "1" && !studentAgeUnder65)
	{
		studentFilingThreshold = 13850;
	}
	if (isirStudentFilingStatus == "2" && studentAgeUnder65 && spouseAge < 65)
	{
		studentFilingThreshold = 24400;
	}
	if (isirStudentFilingStatus == "2" && (studentAgeUnder65 || spouseAge < 65))
	{
		studentFilingThreshold = 25700;
	}
	if (isirStudentFilingStatus == "2" && !studentAgeUnder65 && spouseAge >= 65)
	{
		studentFilingThreshold = 27000;
	}
	...
	{
		studentFilingThreshold = 18350;
	}
	if (isirStudentFilingStatus == "4" && !studentAgeUnder65)
	{
		studentFilingThreshold = 20000;
	}
...
/* Parent Calculate Filing Threshold */
    ...
    else
    {
        ...
        if (isirPARENTSTAXRETURNFILINGSTATUS == "1")
        {
            if (parent1Under65)
            {
                parentFilingThreshold = 12200;
            }
            else
            {
                parentFilingThreshold = 13850;
            }
        }
        if (isirPARENTSTAXRETURNFILINGSTATUS == "4")
        {
            if (parent1Under65)
            {
                parentFilingThreshold = 18350;
            }
            else
            {
                parentFilingThreshold = 20000;
            }
        }
        if (isirPARENTSTAXRETURNFILINGSTATUS == "2")
        {
            ...
            {
                parentFilingThreshold = 24400;
            }
            else if ((parent1Under65 && !parent2Under65) || (!parent1Under65 && parent2Under65))
            {
                parentFilingThreshold = 25700;
            }
            else
            {
                parentFilingThreshold = 27000;
            }
        }
        if (isirPARENTSTAXRETURNFILINGSTATUS == "3")
        {
            parentFilingThreshold = 5;
        }
...
{
 if (isirStudentIrsRequestFlag == "02" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag == "1" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "2" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "3" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "4") && hasRolloverStatement && hasVerificationWorksheetDepStudent)
    {
        studentVerificationStatus = true;
    }
 else if (isirStudentIrsRequestFlag == "02" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag != "1" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "2" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "3" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "4") && hasVerificationWorksheetDepStudent)
    {
        studentVerificationStatus = true;
    }
    
     if ((isirStudentIrsRequestFlag != "02" && isirStudentIrsRequestFlag != "07") && (isirStudentsIRSUntaxedIRADistAndPensionsFlag == "1" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "2" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "3" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "4") && hasRolloverStatement && hasVerificationWorksheetDepStudent && (hasTaxTranscriptStudent || has1040Student || has1040xStudent || hasForeignTaxTranscriptStudent))
    {
        studentVerificationStatus = true;
    }
    
    if ((isirStudentIrsRequestFlag != "02" && isirStudentIrsRequestFlag != "07") && (isirStudentsIRSUntaxedIRADistAndPensionsFlag != "1" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "2" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "3" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "4") && hasVerificationWorksheetDepStudent && (hasTaxTranscriptStudent || has1040Student || has1040xStudent || hasForeignTaxTranscriptStudent))
    {
        studentVerificationStatus = true;
    }
    
    if (isirStudentIrsRequestFlag == "07" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag == "1" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "2" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "3" || isirStudentsIRSUntaxedIRADistAndPensionsFlag == "4") && hasRolloverStatement && hasVerificationWorksheetDepStudent && (hasTaxTranscriptStudent || has1040Student) && has1040xStudent)
    {
        studentVerificationStatus = true;
    } 
    
    if (isirStudentIrsRequestFlag == "07" && (isirStudentsIRSUntaxedIRADistAndPensionsFlag != "1" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "2" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "3" && isirStudentsIRSUntaxedIRADistAndPensionsFlag != "4") && hasVerificationWorksheetDepStudent && (hasTaxTranscriptStudent || has1040Student) && has1040xStudent)
    {
        studentVerificationStatus = true;
    }
...
else
{
    ...
    {
        if (hasVerificationWorksheetDepStudent && (hasNonFilingStudent || hasW2Student || has1099GStudent || hasSelfEmploymentStatementStudent))
        {
...
/* Parent Tax Rules */
    if (isirPARENTSTAXRETURNCOMPLETED == "1" && (isirPARENTSMARITALSTATUS == "1" || isirPARENTSMARITALSTATUS == "2" || isirPARENTSMARITALSTATUS == "3" || isirPARENTSMARITALSTATUS == "4" || isirPARENTSMARITALSTATUS == "5") && isirPARENTSIRSREQUESTFLAG == "02" && hasVerificationWorksheetDepStudent)
    {
        ...
        if ((isirPARENTSIRSUNTAXEDIRADISTANDPENSIONSFLAG == "1" || isirPARENTSIRSUNTAXEDIRADISTANDPENSIONSFLAG == "2" || isirPARENTSIRSUNTAXEDIRADISTANDPENSIONSFLAG == "3" || isirPARENTSIRSUNTAXEDIRADISTANDPENSIONSFLAG == "4") && hasRolloverParent1)
        {
            parentVerificationStatus = true;
...
return studentVerificationStatus && parentVerificationStatus;