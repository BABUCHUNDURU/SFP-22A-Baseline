...
else
{
    ...
    if (isirStudentMaritalStatus == "1" || isirStudentMaritalStatus == "4")
    {
        ...
        {
            if (totalIncome >= filingThreshold && (hasTaxTranscriptStudent || has1040Student || has1040xStudent || hasForeignTaxTranscriptStudent))
            {
                return true;
            }
    ...
    if (isirStudentMaritalStatus == "2" || isirStudentMaritalStatus == "3")
    {
        if (hasVerificationWorksheetIndStudent && hasNonFilingStudent && (hasW2Student || has1099GStudent || hasSelfEmploymentStatementStudent))
        {
            if (totalIncome >= filingThreshold && (((hasTaxTranscriptStudent || has1040Student || has1040xStudent ||  hasForeignTaxTranscriptStudent) && isirFilingStatus != "3") || ((hasTaxTranscriptStudent || has1040Student || has1040xStudent ||  hasForeignTaxTranscriptStudent) && (hasTaxTranscriptSpouse || has1040Spouse || has1040xSpouse ||  hasForeignTaxTranscriptSpouse) && (hasW2Spouse || has1099GSpouse || hasSelfEmploymentStatementSpouse) && isirFilingStatus == "3")))
            {
            ...
            if (totalIncome < filingThreshold)
            {
                ...
                if (isirFilingStatus == "3" && (hasW2Spouse || has1099GSpouse || hasSelfEmploymentStatementSpouse))
                {
                    return true;
                }
            }
