...
if (docOwner == "Student")
{
    ...
    if (docOwner == "Student")
    {
        if (currentDocument.getDocumentFieldValue("AC1015") != null && !currentDocument.getDocumentFieldValue("AC1015").isAllWhitespace())
        {
            selfEmploymentStudent = currentDocument.getDocumentFieldValue("AC1015").toFloat().round();
        }
    }
    else if (hasSelfEmploymentStatementStudent)
    {
    ...
    if (docOwner == "Spouse")
    {
        if (currentDocument.getDocumentFieldValue("AC1015") != null && !currentDocument.getDocumentFieldValue("AC1015").isAllWhitespace())
        {
            selfEmploymentSpouse = currentDocument.getDocumentFieldValue("AC1015").toFloat().round();
        }
    }
    else if (hasSelfEmploymentStatementSpouse)
    {
...
if (docOwner == "Parent1")
{
    ...
    boolean has1099Parent1 = receivedDocuments.hasDoc("1099G", "Parent1") && receivedDocuments.get("1099G", "Parent1").isAcceptable();
    boolean has1099Parent2 = receivedDocuments.hasDoc("1099G", "Parent2") && receivedDocuments.get("1099G", "Parent2").isAcceptable();
    ...
    if (docOwner == "Parent1")
    {
        selfEmploymentParent1 = currentDocument.getDocumentFieldValue("AC1015").toFloat().round();
    }
