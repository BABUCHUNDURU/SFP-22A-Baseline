...
if (docOwner == "Student")
{
	...
	{
		filingThreshold = 12400;
	}
	if (isirFilingStatus == "1" && !studentAgeUnder65)
	{
		filingThreshold = 14050;
	}
	if (isirFilingStatus == "2" && studentAgeUnder65 && spouseAge < 65)
	{
		filingThreshold = 24800;
	}
	if (isirFilingStatus == "2" && (studentAgeUnder65 || spouseAge < 65))
	{
		filingThreshold = 26100;
	}
	if (isirFilingStatus == "2" && !studentAgeUnder65 && spouseAge >= 65)
	{
		filingThreshold = 27400;
	}
	...
	{
		filingThreshold = 18650;
	}
	if (isirFilingStatus == "4" && !studentAgeUnder65)
	{
		filingThreshold = 20300;
	}
    ...
    if (isirStudentMaritalStatus == "1" || isirStudentMaritalStatus == "2" || isirStudentMaritalStatus == "4" || isirStudentMaritalStatus.isAllWhitespace())
    {
    ...
    else if (isirStudentMaritalStatus == "3")
    {
        ...
        if (totalIncome >= filingThreshold)
        {
            ...
            supportingDoc.addAnyDocuments(["IRSForm4868", "Student"], ["IRSExtensionApproval", "Student"], ["TaxReturnTranscript", "Student"],["1040x", "Student"],["ForeignTaxTranscript", "Student"],["TaxReturnTranscript", "Spouse"],["1040x", "Spouse"],["ForeignTaxTranscript", "Spouse"]);
        }
    }
}
else if (docOwner == "Parent1" || docOwner == "Parent2")
{
    ...
    if (docOwner == "Parent1")
    {
        ...
        if (currentAC1010 != null && !currentAC1010.isAllWhitespace())
        {
            w2SumParent1Float = w2SumParent1Float + currentAC1010.toFloat();
        }
    }    
    ...
    if (docOwner == "Parent2")
    {
        ...
        if (currentAC1010 != null && !currentAC1010.isAllWhitespace())
        {
            w2SumParent2Float = w2SumParent2Float + currentAC1010.toFloat();
        }
    }    
    ...
    if (isirPARENTSTAXRETURNFILINGSTATUS == "3")
    {
        ...
        if (totalIncome >= filingThreshold)
        {
            supportingDoc.addAnyDocuments(["IRSForm4868", "Parent1"], ["IRSExtensionApproval", "Parent1"], ["TaxReturnTranscript", "Parent1"],["1040x", "Parent1"],["1040", "Parent1"],["ForeignTaxTranscript", "Parent1"],["IRSForm4868", "Parent2"],["IRSExtensionApproval", "Parent2"],["TaxReturnTranscript", "Parent2"],["1040x", "Parent2"],["1040", "Parent2"],["ForeignTaxTranscript", "Parent2"]);
        }
    }
    else
    {
        supportingDoc.addAnyDocuments(["IRSForm4868", "Parent1"], ["IRSExtensionApproval", "Parent1"], ["TaxReturnTranscript", "Parent1"],["1040x", "Parent1"],["1040", "Parent1"],["ForeignTaxTranscript", "Parent1"]);
    }
}