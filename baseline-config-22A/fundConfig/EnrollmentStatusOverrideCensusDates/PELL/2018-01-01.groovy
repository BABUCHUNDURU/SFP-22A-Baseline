...
if (program.isTerm())
{
    ...
    if (termStartDate < new LocalDate(2018, 10, 2) && termStartDate >= new LocalDate(2018, 7, 1))
    {
        censusDate = new LocalDate(2018, 7, 24);
    }
    else if (termStartDate < new LocalDate(2019, 1, 2) && termStartDate >= new LocalDate(2018, 10, 2))
    {
        censusDate = new LocalDate(2018, 10, 23);
    }
    else if (termStartDate < new LocalDate(2019, 4, 2) && termStartDate >= new LocalDate(2019, 1, 2))
    {
        censusDate = new LocalDate(2019, 1, 22);
    }
    else if (termStartDate < new LocalDate(2019, 7, 2) && termStartDate >= new LocalDate(2019, 4, 2))
    {
        censusDate = new LocalDate(2019, 4, 23);
    }
    else if (termStartDate < new LocalDate(2019, 10, 1) && termStartDate >= new LocalDate(2019, 7, 2))
    {
        censusDate = new LocalDate(2019, 7, 23);
    }
    else if (termStartDate < new LocalDate(2020, 1, 2) && termStartDate >= new LocalDate(2019, 10, 1))
    {
        censusDate = new LocalDate(2019, 10, 22);
    }
